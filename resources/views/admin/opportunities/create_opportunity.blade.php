<x-admin-master>
    ...
    @section('content')
    <form action="{{route('store.Opportunity')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="col-md-6 m-auto mt-5 ">
            <div class="card mb-4">
                ...
                <div class="card-body pb-0">
                    <label for="largeSelect" class="form-label">Select Company</label>
                    <select name="user_id" id="largeSelect" class="form-select form-select-lg">
