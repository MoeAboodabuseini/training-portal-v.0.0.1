            ...
            <div class="card mb-4">
                ...
                <div class="card-body pb-0">
                    <div class="form-floating">
                        <input value="{{$admin->name}}" type="text" class="form-control" id="floatingInput" placeholder="User Name" aria-describedby="floatingInputHelp" name="name" />
                ...
                <div class="card-body pb-0">
                    <div class="form-floating">
                        <input value="{{$admin->user_id}}" type="number" class="form-control" id="floatingInput" placeholder="User ID" aria-describedby="floatingInputHelp" name="user_id" />
